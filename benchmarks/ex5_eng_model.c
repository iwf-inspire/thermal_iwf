...
static void init_top(particle *particles, double hdy, double *dx1) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/top_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/top_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/top.txt", "r");
		else             file = fopen("./coords/ascii_large/top.txt", "r");
...
static void init_connector_top(particle *particles, double hdy, double *dx2) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/connector_top_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/connector_top_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/connector_top.txt", "r");
		else		     file = fopen("./coords/ascii_large/connector_top.txt", "r");
...
static void init_inlet(particle *particles, double hdy, double *dx3) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/inlet_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/inlet_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/inlet.txt", "r");
		else 			 file = fopen("./coords/ascii_large/inlet.txt", "r");
...
static void init_connector_inlet(particle *particles, double hdy, double *dx4) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/connector_inlet_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/connector_inlet_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/connector_inlet.txt", "r");
		else 			 file = fopen("./coords/ascii_large/connector_inlet.txt", "r");
...
static void init_connector_bar_center(particle *particles, double hdy, double *dx5) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/connector_bar_center_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/connector_bar_center_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/connector_bar_center.txt", "r");
		else             file = fopen("./coords/ascii_large/connector_bar_center.txt", "r");
...
static void init_bar(particle *particles, double hdy, double *dx6) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/bar_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/bar_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/bar.txt", "r");
		else             file = fopen("./coords/ascii_large/bar.txt", "r");
...
static void init_cross_1(particle *particles, double hdy, double *dx7) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/cross_1_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/cross_1_mod.txt", "r");
	else
		if (small_model)file = fopen("./coords/ascii_small/cross_1.txt", "r");
		else 	    	file = fopen("./coords/ascii_large/cross_1.txt", "r");
...
static void init_cross_2(particle *particles, double hdy, double *dx8) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/cross_2_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/cross_2_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/cross_2.txt", "r");
		else 			 file = fopen("./coords/ascii_large/cross_2.txt", "r");
...
static void init_connector_heat_sink(particle *particles, double hdy, double *dx9) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/connector_heat_sink_mod.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/connector_heat_sink_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/connector_heat_sink.txt", "r");
		else             file = fopen("./coords/ascii_large/connector_heat_sink.txt", "r");
...
static void init_heat_sink(particle *particles, double hdy, double *dx10) {
	...
	if (model_mod)
		if (small_model) file = fopen("./coords/ascii_smallest_simpl_heatsink/heat_sink_mod_simpl.txt", "r");
		else             file = fopen("./coords/ascii_checked_smaller/heat_sink_mod.txt", "r");
	else
		if (small_model) file = fopen("./coords/ascii_small/heat_sink.txt", "r");
		else 			 file = fopen("./coords/ascii_large/heat_sink.txt", "r");
